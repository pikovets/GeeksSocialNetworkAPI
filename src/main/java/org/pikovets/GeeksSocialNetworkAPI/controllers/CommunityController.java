...
public class CommunityController {
    ...
    public ResponseEntity<CommunityRoleResponse> getCurrentUserRole(@PathVariable("communityId") UUID communityId) {
        return new ResponseEntity<>(new CommunityRoleResponse(communityService.getCurrentUserRole(communityId, authenticationFacade.getUserID())), HttpStatus.OK);
    }

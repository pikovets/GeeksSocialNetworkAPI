...
public class UserRelationshipController {
    ...
    @Operation(
            ...
            description = "Get friend request by user id",
            parameters = {
                    @Parameter(
                            name = "userId",
                            description = "User id",
    ...
    @Operation(
            ...
            description = "Send friend request by user id. The request will be pending acceptance by another user",
            parameters = {
                    @Parameter(
                            name = "userId",
                            description = "User id",
    ...
    @Operation(
            ...
            description = "Accept friend request by user id",
            parameters = {
                    @Parameter(
                            name = "userId",
                            description = "User id",
    ...
    @Operation(
            ...
            description = "Delete friend request by user id",
            parameters = {
                    @Parameter(
                            name = "userId",
                            description = "User id",
